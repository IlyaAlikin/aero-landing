    ...
    <div class="container">
      ...
      <div class="panel">
        <div class="pcol">
          ...
          <a class="pcol__btn" href="https://payform.ru/6hbRMa3/" target="_blank" rel="noopener"><AppButton label="Перейти к покупке" variant="pink" size="md" /></a>
        </div>
        <div class="pcol">
          ...
          <a class="pcol__btn" href="https://payform.ru/bqbRMcR/" target="_blank" rel="noopener"><AppButton label="Перейти к покупке" variant="beige" size="md" /></a>
        </div>
      </div>
    </div>
  </section>
